...
# Page configuration
st.set_page_config(page_title="Life Deadline Calculator", layout="wide")

# Title and description
st.title("Life Deadline Calculator")
st.write("Calculate how many seconds you have left based on life expectancy data.")
